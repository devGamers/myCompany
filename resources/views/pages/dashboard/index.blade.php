                                            ...
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    ...
                                                    <div class="media-body text-white text-right align-self-bottom">
                                                        <a href="{{ route('dashboard.travailleur') }}" class="text-white text-bold-700 btn btn-bg-gradient-x-blue-green">Accéder</a>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    ...
                                                    <div class="media-body text-white text-right align-self-bottom">
                                                        <a href="{{ route('dashboard.entree-sortie') }}" class="text-white text-bold-700 btn btn-bg-gradient-x-orange-yellow">Accéder</a>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    ...
                                                    <div class="media-body text-white text-right align-self-bottom">
                                                        <a href="{{ route('dashboard.parametre') }}" class="text-white text-bold-700 btn btn-bg-gradient-x-red-pink">Accéder</a>
                                                        <span class="d-block mb-1 font-medium-1 mt-2">Gestion des paramètres généraux</span>
                                                        <h1 class="text-white mb-0">Paramètres</h1>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
